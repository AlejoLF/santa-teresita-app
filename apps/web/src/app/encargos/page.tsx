        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {delDia.map((e) => (
            <button
              ...
              className="card p-3.5 text-left hover:shadow-md transition-shadow border-l-4 border-wood-600 flex flex-col gap-1.5"
            >
              ...
              <div className="text-xs text-ink-500 flex items-center gap-2 flex-wrap">
                ...
                <span>· {e.itemsCount} ítem{e.itemsCount === 1 ? '' : 's'}</span>
              </div>
